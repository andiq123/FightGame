...
const HEAVY = {
  ...
  attack: { mult: 1.38, stretch: 1.42, speed: 0.78 },
  idleKind: 'heavy',
  limb: 1.18,
};
...
export const PROFILES = {
  ...
  _fly: { idleKind: 'hover', air: { bob: 5, lift: -6, flapSpeed: 5.2, flapAmp: 0.55, flapLift: 5 } },
  _boss: {
    ...
    attack: { mult: 1.52, stretch: 1.58, speed: 0.74 },
    idleKind: 'heavy',
    limb: 1.28,
  },
  ...
  ninja: {
    ...
    idleKind: 'ninja',
    attack: { mult: 1.12, stretch: 1.15, speed: 1.22 },
  },
  brute: { ...HEAVY, walk: { cycleMul: 0.6, bob: 0.7, leg: 0.68, arm: 0.8 }, attack: { mult: 1.48, stretch: 1.55, speed: 0.72 }, limb: 1.22 },
  giant: { ...HEAVY, rest: { torsoLean: 0.2, lKneeAng: 0.58, rKneeAng: 0.5 }, walk: { cycleMul: 0.52, bob: 0.62, leg: 0.62, arm: 0.75 }, attack: { mult: 1.58, stretch: 1.68, speed: 0.68 }, idleKind: 'heavy', limb: 1.35 },
  ...
  skyrider: { idleKind: 'hover', air: { bob: 8, lift: -8, flapSpeed: 5.6, flapAmp: 0.58, flapLift: 6 }, walk: { cycleMul: 0.85, bob: 0.45 } },
  hawk: { idleKind: 'hover', air: { bob: 10, lift: -6, flapSpeed: 6.2, flapAmp: 0.72, flapLift: 7 }, walk: { cycleMul: 1.05, bob: 0.5 } },
  ...
  titan: { rest: { torsoLean: 0.18, lKneeAng: 0.55, rKneeAng: 0.48 }, walk: { cycleMul: 0.52, bob: 0.6, leg: 0.58 }, attack: { mult: 1.6, stretch: 1.65, speed: 0.65 }, idleKind: 'heavy', limb: 1.32 },
  shade: { idleKind: 'ninja', walk: { cycleMul: 1.08, bob: 0.75 }, attack: { mult: 1.22, stretch: 1.25, speed: 1.15 } },
};
...
if (typeof process !== 'undefined' && process.argv?.[1]?.endsWith('anim.js')) {
  ...
  console.assert(giant.attack?.speed < 0.75, 'giant attacks read heavy');
